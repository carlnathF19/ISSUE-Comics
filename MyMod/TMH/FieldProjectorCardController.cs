...
namespace ISSUEComics.TMH
{
	public class FieldProjectorCardController : CardController
	{
		...
		public override IEnumerator UsePower(int index = 0)
		{
			...
			IEnumerator coroutine = gameController.SelectTargetsAndDealDamage(decisionMaker, source, powerNumeral2, DamageType.Energy, numberOfTargets, optional: false, requiredTargets, isIrreducible: false, allowAutoDecide: false, autoDecide: false, null, null, null, null, null, selectTargetsEvenIfCannotDealDamage: false, null, null, ignoreBattleZone: false, null, cardSource);
